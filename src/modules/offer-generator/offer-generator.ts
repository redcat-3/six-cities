...
import { LATITUDE, LOCATION_COUNT_DIGIT, LONGITUDE, MAX_GEST_NUMBER, MAX_PRICE, MAX_RATING, MAX_ROOMS_NUMBER, MIN_GEST_NUMBER, MIN_PRICE, MIN_RATING, MIN_ROOMS_NUMBER, PRICE_COUNT_DIGIT, RATING_COUNT_DIGIT, WEEK_DAY } from '../offer/offer.constant.js';
...
export default class OfferGenerator implements OfferGeneratorInterface {
  ...
  public generate(): string {
    ...
    const rating = generateRandomValue(MIN_RATING, MAX_RATING, RATING_COUNT_DIGIT).toString();
